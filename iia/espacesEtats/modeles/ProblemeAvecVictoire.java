 ...
 */
public abstract class ProblemeAvecVictoire {
  ...
  /* ********* Constructeurs *********** */
	 ...
	 */
	public ProblemeAvecVictoire(Etat eInit,String nom){
		etatInitial = eInit;
  ...
  /* ********* Autres méthodes *********** */
	 ...
	 * @throws Exception 
	 */
	public abstract boolean isGagne(Etat e);

	public abstract boolean isPerdu(Etat e);
